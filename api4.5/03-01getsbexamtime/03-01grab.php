...
function getInfo(){
    ...
    // 1. 初始化
    $ch = curl_init();
    $login_url = 'https://zhjw.neu.edu.cn/ACTIONLOGON.APPPROCESS?mode=1&applicant=ACTIONQUERYEXAMTIMETABLEBYSTUDENT';
    // 2. 设置选项，包括URL
...
function sendPost(){
    ...
    $header = array(
        ...
        'Referer: https://zhjw.neu.edu.cn/ACTIONLOGON.APPPROCESS?mode=1&applicant=ACTIONQUERYEXAMTIMETABLEBYSTUDENT',
...
function getInfo2(){
    ...
    $ch = curl_init();
    $login_url = 'https://zhjw.neu.edu.cn/ACTIONQUERYEXAMTIMETABLEBYSTUDENT.APPPROCESS?mode=2';
    // 设置选项，包括URL
    //$header = array();
